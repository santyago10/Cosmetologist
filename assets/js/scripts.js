...
jQuery(document).ready(function() {
    ...
    */
    $('.top-content').backstretch("assets/img/backgrounds/diz.png");
    $('.counters-container').backstretch("assets/img/backgrounds/mra.jpg");
    $('.our-motto-container').backstretch("assets/img/backgrounds/mra.jpg");
